...
def run_raw_to_cleaned_pipeline():
    ...
    raw_s3_bucket_filepath = f"s3a://main-raw-tick-data-bucket/{date.today().isoformat()}"
    cleaned_s3_bucket_filepath =  f"s3a://main-clean-tick-data-bucket/{date.today().isoformat()}"
